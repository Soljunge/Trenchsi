...
TrenchLaw provides QQ support via the official Bot API from the QQ Open Platform.
...
The QQ Open Platform provides a one-click creation entry for TrenchLaw QQ bots:
...
3. Fill in the credentials in the TrenchLaw configuration file
4. Run `trenchlaw gateway` to start the service
...
4. Fill in the credentials in the TrenchLaw configuration file
5. Run `trenchlaw gateway` to start the service
