...
5. Fill in the App ID and App Secret in the TrenchLaw configuration file
6. Run `trenchlaw gateway` to start the service
7. Search for the bot name in Feishu and start a conversation

> TrenchLaw connects to Feishu using WebSocket/SDK mode — no public callback address or Webhook URL is required.
>
