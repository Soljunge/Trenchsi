          ...
          <div className="relative grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(18rem,0.9fr)]">
            ...
            <div className="grid gap-3">
              <StepCard
                ...
                description="Connect OpenAI, Anthropic, OpenRouter, Ollama, or any compatible endpoint so Trenchsi has something to run."
          ...
          <div className="relative grid gap-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(18rem,0.95fr)]">
            ...
            <div className="grid gap-3">
              <StepCard
                step="Do this now"
                title="Start the gateway"
                description="Use the orange button in the top bar. Trenchsi only needs a few seconds before the chat connects."
              ...
              <StepCard
                ...
                description='You can also run `trenchsi gateway` directly if you want the service started outside the web launcher.'
