...
Important:
- For city names entered in Chinese script, geocoding may return smaller homonym locations first. Prefer the Latin spelling such as `Chengdu` after verifying it matches Sichuan, China.
