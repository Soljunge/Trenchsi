...
Examples:
  trenchsi model                    # Show current default model
  trenchsi model gpt-5.2           # Set gpt-5.2 as default
  trenchsi model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  trenchsi model local-model       # Set local VLLM server as default
