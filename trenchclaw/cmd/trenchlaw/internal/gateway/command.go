...
import (
	...
	"github.com/sipeed/trenchlaw/pkg/gateway"
...
func NewGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:     "gateway",
		Aliases: []string{"g"},
		Short:   "Start trenchclaw gateway",
		Args:    cobra.NoArgs,
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			return gateway.Run(debug, internal.GetJameclawHome(), internal.GetConfigPath(), allowEmpty)
		},
	}
