...
Examples:
  trenchclaw model                    # Show current default model
  trenchclaw model gpt-5.2           # Set gpt-5.2 as default
  trenchclaw model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  trenchclaw model local-model       # Set local VLLM server as default
