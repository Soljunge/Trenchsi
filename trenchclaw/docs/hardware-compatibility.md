# 🖥️ TrenchLaw Hardware Compatibility List

TrenchLaw runs on virtually any Linux device. This page tracks verified chips, products, and development boards.
...
Consumer products, routers, and industrial devices that have been tested with TrenchLaw.
...
Any ARM64 Android phone (2015+) with 1GB+ RAM. Install [Termux](https://github.com/termux/termux-app), use `proot` to run TrenchLaw.
...
wget https://github.com/sipeed/trenchlaw/releases/latest/download/trenchlaw_Linux_arm64.tar.gz
...
# 3. Test
./trenchlaw agent -m "Hello, what board am I running on?"
```
