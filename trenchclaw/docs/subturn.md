...
The `SubTurn` mechanism is a core feature in TrenchLaw that allows tools to spawn isolated, nested agent loops to handle complex sub-tasks.
...
SubTurns emit specific events to the TrenchLaw `EventBus` for observability and debugging:
