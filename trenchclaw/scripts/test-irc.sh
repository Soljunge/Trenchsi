...
CONTAINER_NAME="trenchlaw-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.trenchlaw/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run trenchlaw:"
echo "  cd packages/trenchlaw && go run ./cmd/trenchlaw gateway"
echo ""
...
echo "  Join #test, then: jamebot: hello"
echo ""
