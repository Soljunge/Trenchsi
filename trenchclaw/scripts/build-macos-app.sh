#!/bin/bash
# Build macOS .app bundle for TrenchClaw Launcher
...
APP_NAME="TrenchClaw Launcher"
APP_PATH="./build/${APP_NAME}.app"
APP_CONTENTS="${APP_PATH}/Contents"
APP_MACOS="${APP_CONTENTS}/MacOS"
APP_RESOURCES="${APP_CONTENTS}/Resources"
APP_EXECUTABLE="trenchlaw-launcher"
...
if [ -f "./build/trenchlaw" ]; then
    cp "./build/trenchlaw" "${APP_MACOS}/"
else
    echo "Error: ./build/trenchlaw not found. Please build the main file first."
    echo "Run: make build"
    exit 1
fi
chmod +x "${APP_MACOS}/"*
...
<dict>
    ...
    <string>trenchlaw-launcher</string>
    <key>CFBundleIdentifier</key>
    <string>com.trenchlaw.launcher</string>
    <key>CFBundleName</key>
    <string>TrenchClaw Launcher</string>
