...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.trenchlaw")
	assert.Equal(t, "/home/user/.trenchlaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.trenchlaw/workspace/file.txt", "/home/user/.trenchlaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".trenchlaw"), result)
}
