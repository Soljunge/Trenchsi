...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			repo:         "sipeed/trenchlaw",
			wantOwner:    "sipeed",
			wantRepoName: "trenchlaw",
			wantRef:      "main",
			wantSubPath:  "",
		},
		{
			name:         "owner/repo with subpath",
			repo:         "sipeed/trenchlaw/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "trenchlaw",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/sipeed/trenchlaw/tree/dev/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "trenchlaw",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/sipeed/trenchlaw/blob/main/README.md",
			wantOwner:    "sipeed",
			wantRepoName: "trenchlaw",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/sipeed/trenchlaw",
			wantOwner:    "sipeed",
			wantRepoName: "trenchlaw",
			wantRef:      "main",
			wantSubPath:  "",
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	existingSkill := filepath.Join(skillsDir, "trenchlaw")
	...
	err = installer.InstallFromGitHub(context.Background(), "sipeed/trenchlaw")
	if err == nil {
