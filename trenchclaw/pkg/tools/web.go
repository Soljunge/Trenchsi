...
const (
	...
	userAgentHonest = "trenchlaw/%s (+https://github.com/sipeed/trenchlaw; AI assistant bot)"
...
func (p *SearXNGSearchProvider) Search(ctx context.Context, query string, count int) (string, error) {
	...
	// Format results in standard TrenchLaw format
...
func (t *WebFetchTool) Execute(ctx context.Context, args map[string]any) *ToolResult {
	...
	// Retry once with an honest User-Agent that identifies trenchlaw, which some
