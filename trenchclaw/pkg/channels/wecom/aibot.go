...
// WeComAIBotChannel implements the Channel interface for the WeCom AI Bot integration.
...
func (c *WeComAIBotChannel) handleVerification(
	...
	// Decrypt echostr
	// For the WeCom AI Bot integration, receiveid should be an empty string.
...
func (c *WeComAIBotChannel) handleMessageCallback(
	...
	// Decrypt message
	// For the WeCom AI Bot integration, receiveid is an empty string.
