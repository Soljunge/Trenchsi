...
import (
	...
	anthropicmessages "github.com/sipeed/trenchlaw/pkg/providers/anthropic_messages"
	"github.com/sipeed/trenchlaw/pkg/providers/azure"
	"github.com/sipeed/trenchlaw/pkg/providers/bedrock"
)
...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: trenchlaw auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: trenchlaw auth login --provider openai")
	}
