...
import (
	...
	anthropicprovider "github.com/sipeed/trenchlaw/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: trenchlaw auth login --provider anthropic")
		}
