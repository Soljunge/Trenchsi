...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open TrenchClaw console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About TrenchClaw",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit TrenchClaw",
		Exiting:            "Exiting TrenchClaw...",
		DocUrl:             "https://docs.trenchlaw.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "Open Console",
